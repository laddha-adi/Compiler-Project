...
{
	switch(hashFun(s)){
    	case : hashFun("program")  return 100;
    	case : hashFun("mainFunction")  return 101;
    	case : hashFun("otherFunctions")  return 102;
    	case : hashFun("function")  return 103;
    	case : hashFun("input_par")  return 104;
    	case : hashFun("output_par")  return 105;
    	case : hashFun("parameter_list")  return 106;
    	case : hashFun("dataType")  return 107;
    	case : hashFun("primitiveDatatype")  return 108;
   		case : hashFun("constructedDatatype")  return 109;
    	case : hashFun("remaining_list")  return 110;
    	case : hashFun("stmts")  return 111;
    	case : hashFun("typeDefinitions")  return 112;
    	case : hashFun("typeDefinition")  return 113;
    	case : hashFun("fieldDefinitions")  return 114;
    	case : hashFun("fieldDefinition")  return 115;
    	case : hashFun("moreFields")  return 116;
    	case : hashFun("declarations")  return 117;
    	case : hashFun("declaration")  return 118;
    	case : hashFun("global_or_not")  return 119;
    	case : hashFun("otherStmts")  return 120;
    	case : hashFun("stmt")  return 121;
    	case : hashFun("assignmentStmt")  return 122;
    	case : hashFun("singleOrRecId")  return 123;
    	case : hashFun("funCallStmt")  return 124;
    	case : hashFun("outputParameters")  return 125;
    	case : hashFun("inputParameters")  return 126;
    	case : hashFun("iterativeStmt")  return 127;
    	case : hashFun("conditionalStmt")  return 128;
    	case : hashFun("elsePart")  return 129;
    	case : hashFun("ioStmt")  return 130;
    	case : hashFun("allVar")  return 131;
    	case : hashFun("arithmeticExpression")  return 132;
    	case : hashFun("expPrime")  return 133;
    	case : hashFun("term")  return 134;
    	case : hashFun("termPrime")  return 135;
    	case : hashFun("factor")  return 136;
    	case : hashFun("highPrecedenceOperators")  return 137;
    	case : hashFun("lowPrecedenceOperators")  return 138;
    	case : hashFun("all")  return 139;
    	case : hashFun("temp")  return 140;
    	case : hashFun("booleanExpression")  return 141;
   		case : hashFun("var")  return 142;
    	case : hashFun("logicalOp")  return 143;
    	case : hashFun("relationalOp")  return 144;
    	case : hashFun("returnStmt")  return 145;
    	case : hashFun("optionalReturn")  return 146;
    	case : hashFun("idList")  return 147;
    	case : hashFun("more_ids")  return 148;
    	case : hashFun("new24")  return 149;
	    case : hashFun("newVar")  return 150;
	}
}
